...
class Tools(AppBase):
    ...
    def send_email_Oneflow(self, apikey, recipients, subject, body):
        targets = [recipients]
        if ", " in recipients:
    ...
    def execute_python(self, code, Oneflow_input):
        print("Run with Oneflow_data %s" % Oneflow_input)
        ...
        return "Some return: %s" % Oneflow_input
